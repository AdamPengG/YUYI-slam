...
def run_scene(
    ...
    ovo_config_path: str = "data/working/configs/ovo.yaml",
) -> None:
    ...
    for scene in scenes:        
        ...
        if args.run:
            ...
            run_scene(
                ...
                experiment_name,
                tmp_run=tmp_run,
                ovo_config_path=args.ovo_config,
            )
            t1 = time.time()
...
if __name__ == "__main__":
    ...
    parser.add_argument('--ovo_config', default="data/working/configs/ovo.yaml", type=str)
