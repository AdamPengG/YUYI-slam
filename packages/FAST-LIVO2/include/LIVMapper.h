...
public:
  ...
  void publish_camera_pose_at_image(const rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr &pubCameraPoseAtImage, double image_time_sec);
  ...
  rclcpp::Publisher<nav_msgs::msg::Odometry>::SharedPtr pubCameraPoseAtImage;
